#!/bin/bash
###################################################################
# Description: Rocky 9/Debian 12 initSystem.sh
# Arch: Rocky 8/CentOS 8
# Author: Jeff
# Mail: shiyao.zh@gmail.com
# Link: https://github.com/cby-chen/OS
...
dnf update -y; dnf install -y curl git wget ntpdate lsof net-tools telnet vim lrzsz tree nmap nc sysstat epel*
